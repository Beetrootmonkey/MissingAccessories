...
{
    class FieryThrowingKnives : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Rapidly throw burning knives");  //The (English) text shown below your weapon's name
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.useStyle = 1;
            item.shootSpeed = 13f;
            item.shoot = ProjectileType<FieryThrowingKnife>();
            item.damage = 18;
            item.width = 18;
            item.height = 20;
